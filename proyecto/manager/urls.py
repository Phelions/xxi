...
from manager.views import  perfil_admin, listar_cliente, administrar_mesas, crear_empleado, modificar_empleado ,listar_empleado, administrar_reservas, administrar_menu, administrar_inventario, empleados
